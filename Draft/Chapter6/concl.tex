...
% Hierarchical structure of the dark matter web: 
...
% Within the dark matter web (regions with $n_{str} > 1$), the walls are regions where $n_{str} \cong 3$. 
...
\subsection{Geometric view of the multistream haloes}

% Multistream view of the dark matter haloes: 
...
% Topological transitions in the cosmic web: 
...
\centering\includegraphics[width=7.5cm]{Chapter2/Plots/ff0_slice.pdf} 
\centering\includegraphics[width=7.5cm]{Chapter2/Plots/ff1_slice.pdf} 
 \centering\includegraphics[width=8.0cm]{Chapter2/Plots/ffq.pdf} 
\end{minipage}\hfill
