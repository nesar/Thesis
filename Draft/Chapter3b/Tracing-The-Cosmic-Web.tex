...
\begin{figure*}
 \mbox{\hskip -1.27truecm\includegraphics[width=1.1\textwidth]{./FIGS/fig0v2-200Mpc-512}}
 \vspace{-0.6cm}
...
\input{alpaslan.tex} % MST
\input{tempel.tex} % Bisous
\input{gonzalez.tex} % FINE
\input{libeskind.tex} % V-web
\input{forero-romero.tex} % T-web
\input{MMF-Nexus.tex} % MMF-Nexus
%\input{cautun.tex} % NEXUS
%\input{Aragon-MMF.tex}
\bigskip
\input{nuza.tex} %classic
\input{Aragon-Spine.tex}
\input{Disperse.tex}
\input{ORIGAMI.tex} % ORIGAMI
\input{shandarin.tex}
...
\begin{figure*}
 \includegraphics[width=\textwidth]{./FIGS/fig1v4b.eps}
 \vspace{-.4cm}
...
%\end{figure*}
%\begin{figure*}
 \includegraphics[width=\textwidth]{./FIGS/fig2-200Mpc-512}
 \vspace{-1.cm}
...
\begin{figure*}
 \includegraphics[width=\textwidth]{./FIGS/fig3v2-option1}
 \vspace{-1.cm}
...
\begin{figure*}
 \includegraphics[width=\textwidth]{./FIGS/haloagree_v2-200Mpc-512}
 \vspace{-.4cm}
...
\begin{figure*}
 \includegraphics[width=\textwidth]{./FIGS/haloagree_dotplot.eps}
 \vspace{-.4cm}
