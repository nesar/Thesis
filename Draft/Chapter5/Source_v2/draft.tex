...
We have analysed functional variation of the scalar field $-n_{str}(\bmath{x})$ using Hessian eigenvalues. The Hessian analysis is generally done for inherently continuous fields since it requires  evaluation of the second derivatives. % of  $n_{str}(\bmath{x})$. }
